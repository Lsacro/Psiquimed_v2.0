    ...
    >
      ...
      {isHover ? (
        <div className='absolute bottom-0 left-0 p-6 z-10 '>
          <h3 className='text-2xl font-bold text-white traniction-all duration-300 opacity-0 '>{doctor.nombre}</h3>

          <p className='text-sm uppercase tracking-wider text-purple-200 mt-2 traniction-all duration-300 opacity-0'>{doctor.especialidad}</p>
        </div>
      ) : (
        <div className='absolute bottom-0 left-0 p-6 z-10'>
